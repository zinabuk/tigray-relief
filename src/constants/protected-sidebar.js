const SIDEBARITEMS = {
  ADMIN_TABS: {
    CORE_TABS: [
      ...
      { label: 'Our Products', name: 'admin-services', icon: 'hands-helping' },
      {label:'Our Departments',name:'admin-departments',icon:'cogs'},
      { label: 'Managing Directors', name: 'team', icon: 'users' },
