...
=======
    if (response.success) { 
>>>>>>> 64f398235ce3839faa8830fa9b5259af3ebff193
...
<template>
  <section class="w-full">
    <div class="w-full relative">
      ...
      >
        <h1 class="text-4xl font-bold">strategy</h1>
        <div class="flex gap-4">
          <a href="/" class="px-4 py-2 rounded-xl text-white font-bold">Home</a>
          <a href="/strategy" class="text-[#539000] px-4 py-2">strategy</a>
        </div>
      </div>
    </div>
  </section>
